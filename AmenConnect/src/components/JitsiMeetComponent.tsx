...
const JitsiMeetComponent: React.FC = () => {
  ...
  // ==============================
  // The tenant should be the encoded JWT's "sub" value.
  const tenant = "vpaas-magic-cookie-3aaa5c6dc3d342e0b40703fe93348e6a";
  // This is your encoded JWT. It must include the moderator flag in its payload.
  ...
  // ==============================
  // Use your JaaS domain (e.g., 8x8.vc) along with your tenant and room name.
